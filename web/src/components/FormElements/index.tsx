...
import FormElementsTextAreaActive from "./FormElementsTextAreaActive";
import FormElementsTextAreaDisabled from "./FormElementsTextAreaDisabled";

export const FormElements = {
  Root: FormElementsRoot,
  FHeader: FormElementsHeader,
  FBody: FormElementsBody,
  FContainer: FormElementsContainer,
  FContainerDivider: FormElementsContainerDivider,
  FInputs: FormElementsInputs,
  FInputsActive: FormElementsInputsActive,
  FInputsDisabled: FormElementsInputsDisabled,
  FLabels: FormElementsLabel,
